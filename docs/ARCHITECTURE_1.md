...
signoff не FSM, не QC - это точка ответственности
QC reject правильно ищет last approved signoff → ты это уже реализовал верно
scope="full" можно добавить позже как расширение, сейчас он не нужен
...
6) Bootstrap — system action, не user action
---
